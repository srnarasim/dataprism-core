...
class cg{constructor(a,b){this.keys=a;this.Rb=b;this.wb=0;this.Ob=a.length}[Symbol.iterator](){return this}next(){const a=this.wb;if(a===this.Ob)return{done:!0,value:null};this.wb++;return{done:!1,value:[this.keys.get(a),xf.visit(this.Rb,a)]}}}
...
child:d=(new yg).visit({type:b.childType})}=a,e=p(Uint8Array,a.nullBitmap),f=p(Int32Array,a.valueOffsets),{length:h=f.length-1,nullCount:k=a.nullBitmap?-1:0}=a;return new N(b,c,h,k,[f,void 0,e],[d])}}const zg=new yg;function O(a){return zg.visit(a)};class Ag{constructor(a=0,b){this.xb=a;this.vb=b;this.Va=0;this.ub=this.vb(0)}next(){for(;this.Va<this.xb;){const a=this.ub.next();if(!a.done)return a;++this.Va<this.xb&&(this.ub=this.vb(this.Va))}return{done:!0,value:null}}[Symbol.iterator](){return this}}function Bg(a){return a.some(b=>b.nullable)}function Cg(a){return a.reduce((b,c)=>b+c.nullCount,0)}function Dg(a){return a.reduce((b,c,d)=>{b[d+1]=b[d]+c.length;return b},new Uint32Array(a.length+1))}
...
b*c);default:return a.reduce((e,{values:f,length:h})=>{e.pb.set(f.subarray(0,h*c),e.offset);e.offset+=h*c;return e},{pb:new d(b*c),offset:0}).pb}}return[...this]}toString(){return`[${[...this].join()}]`}getChild(a){return this.getChildAt(this.type.children?.findIndex(b=>b.name===a))}getChildAt(a){return-1<a&&a<this.numChildren?new L(this.data.map(({children:b})=>b[a])):null}get isMemoized(){return I.isDictionary(this.type)?this.data[0].dictionary.isMemoized:!1}memoize(){if(I.isDictionary(this.type)){const a=
...
this.j.buffer:null}get values(){return this.o?this.o.buffer:null}get nullBitmap(){return this.D?this.D.buffer:null}get typeIds(){return this.X?this.X.buffer:null}append(a){return this.set(this.length,a)}isValid(a){return this.jb(a)}set(a,b){this.setValid(a,this.isValid(b))&&this.setValue(a,b);return this}setValue(a,b){this.A(this,a,b)}setValid(a,b){this.length=this.D.set(a,+b).length;return b}addChild(){throw Error(`Cannot append children to non-nested type "${this.type}"`);}getChildAt(a){return this.children[a]||
...
class kh{static decode(a){a=new Sa(p(Uint8Array,a));a=(new gh).i(a.u(a.position())+a.position(),a);const b=R.decode(a.schema(),new Map,a.version());return new lh(b,a)}static encode(a){const b=new gb;var c=R.encode(b,a.schema);db(b,24,a.numRecordBatches,8);for(var d of[...a.ab()].slice().reverse())mh.encode(b,d);d=eb(b);db(b,24,a.numDictionaries,8);for(const e of[...jh(a)].slice().reverse())mh.encode(b,e);a=eb(b);z(b,5);y(b,1,c);Za(b,t.V5,t.V1);y(b,3,d);y(b,2,a);c=A(b);b.finish(c);return Ta(b)}get numRecordBatches(){return this.Z.length}get numDictionaries(){return this.hb.length}constructor(a,
b=t.V5,c,d){this.schema=a;this.version=b;c&&(this.Z=c);d&&(this.hb=d)}*ab(){for(let a,b=-1,c=this.numRecordBatches;++b<c;)if(a=this.ea(b))yield a}ea(a){return 0<=a&&a<this.numRecordBatches&&this.Z[a]||null}Da(a){return 0<=a&&a<this.numDictionaries&&this.hb[a]||null}}
class lh extends kh{get numRecordBatches(){var a=this.m;const b=x(a.g,a.h,10);return b?Ra(a.g,a.h+b):0}get numDictionaries(){var a=this.m;const b=x(a.g,a.h,8);return b?Ra(a.g,a.h+b):0}constructor(a,b){super(a,b.version());this.m=b}ea(a){return 0<=a&&a<this.numRecordBatches&&(a=this.m.ab(a))?mh.decode(a):null}Da(a){return 0<=a&&a<this.numDictionaries&&(a=this.m.dictionaries(a))?mh.decode(a):null}}
class mh{static decode(a){return new mh(a.Wa(),a.bodyLength(),a.offset())}static encode(a,b){var c=BigInt(b.offset),d=b.Wa;b=BigInt(b.bodyLength);Va(a,8,24);a.Y(BigInt(b??0));Ua(a,4);a.V(d);a.Y(BigInt(c??0));return a.offset()}constructor(a,b,c){this.Wa=a;this.offset=H(c);this.bodyLength=H(b)}};const T=Object.freeze({done:!0,value:void 0});class nh{constructor(a){this.la=a}get schema(){return this.la.schema}get batches(){return this.la.batches||[]}get dictionaries(){return this.la.dictionaries||[]}}function oh(a){return a.fb||(a.fb=a.toDOMStream())}function ph(a,b,c){return ph(a.lb||(a.lb=a.toNodeStream()),b,c)}class qh{tee(){return oh(this).tee()}pipeTo(a,b){return oh(this).pipeTo(a,b)}pipeThrough(a,b){return oh(this).pipeThrough(a,b)}}
class rh extends qh{constructor(){super();this.o=[];this.ga=[];this.Ja=new Promise(a=>this.K=a)}get closed(){return this.Ja}async cancel(a){await this.return(a)}write(a){if(!this.K)throw Error("AsyncQueue is closed");0>=this.ga.length?this.o.push(a):this.ga.shift().resolve({done:!1,value:a})}abort(a){this.K&&(0>=this.ga.length?this.La={error:a}:this.ga.shift().reject({done:!0,value:a}))}close(){if(this.K){const a=this.ga;for(;0<a.length;)a.shift().resolve(T);this.K();this.K=void 0}}[Symbol.asyncIterator](){return this}toDOMStream(a){return qa(this.K||
this.La?this:this.o,a)}toNodeStream(){return ra()}async throw(a){await this.abort(a);return T}async return(){await this.close();return T}async read(a){return(await this.next(a,"read")).value}async peek(a){return(await this.next(a,"peek")).value}next(){return 0<this.o.length?Promise.resolve({done:!1,value:this.o.shift()}):this.La?Promise.reject({done:!0,value:this.La.error}):this.K?new Promise((a,b)=>{this.ga.push({resolve:a,reject:b})}):Promise.resolve(T)}};class sh extends rh{write(a){if(0<(a=p(Uint8Array,a)).byteLength)return super.write(a)}toString(a=!1){return a?aa.decode(this.toUint8Array(!0)):this.toUint8Array(!1).then(ba)}toUint8Array(a=!1){return a?ka(this.o)[0]:(async()=>{const b=[];let c=0;for await(const d of this)b.push(d),c+=d.byteLength;return ka(b,c)[0]})()}}
...
Gh.Int64=Eh;Gh.Uint64=U;function V(a){return a.L[++a.Mb]}function Hh(a){return a.buffers[++a.Lb]}
class Ih extends ze{constructor(a,b,c,d,e=t.V5){super();this.Lb=this.Mb=-1;this.R=a;this.L=b;this.buffers=c;this.dictionaries=d;this.Fa=e}visit(a){return super.visit(a instanceof S?a.type:a)}visitNull(a,{length:b}=V(this)){return O({type:a,length:b})}visitBool(a,{length:b,nullCount:c}=V(this)){return O({type:a,length:b,nullCount:c,nullBitmap:this.C(a,c),data:this.F(a)})}visitInt(a,{length:b,nullCount:c}=V(this)){return O({type:a,length:b,nullCount:c,nullBitmap:this.C(a,c),data:this.F(a)})}visitFloat(a,
...
function ej(a){const {queueingStrategy:b="count"}=a,{highWaterMark:c="bytes"!==b?Number.POSITIVE_INFINITY:16384}=a,d="bytes"!==b?"length":"byteLength";return function*(e){let f=0;const h=Th(a);for(const k of e)h.append(k)[d]>=c&&++f&&(yield h.toVector());if(0<h.finish().length||0===f)yield h.toVector()}};function fj(a,b){return gj(a,b.map(c=>c.data.concat()))}function gj(a,b){const c=[...a.fields],d=[],e={Xa:b.reduce((Na,ib)=>Math.max(Na,ib.length),0)};let f=0,h=0,k=-1;const n=b.length;let q,B=[];for(;0<e.Xa--;){h=Number.POSITIVE_INFINITY;for(k=-1;++k<n;)B[k]=q=b[k].shift(),h=Math.min(h,q?q.length:h);Number.isFinite(h)&&(B=hj(c,h,B,b,e),0<h&&(d[f++]=O({type:new J(c),length:h,nullCount:0,children:B.slice()})))}return[a=a.assign(c),d.map(Na=>new W(a,Na))]}
function hj(a,b,c,d,e){const f=(b+63&-64)>>3;for(let k=-1,n=d.length;++k<n;){const q=c[k];var h=q?.length;h>=b?h===b?c[k]=q:(c[k]=q.slice(0,b),e.Xa=Math.max(e.Xa,d[k].unshift(q.slice(b,h-b)))):(h=a[k],a[k]=h.clone({nullable:!0}),c[k]=q?.Ia(b)??O({type:h.type,length:b,nullCount:b,nullBitmap:new Uint8Array(f)}))}return c};class X{constructor(...a){if(0===a.length)return this.batches=[],this.schema=new R([]),this.j=[0],this;let b,c;a[0]instanceof R&&(b=a.shift());a.at(-1)instanceof Uint32Array&&(c=a.pop());const d=e=>{if(e){if(e instanceof W)return[e];if(e instanceof X)return e.batches;if(e instanceof N){if(e.type instanceof J)return[new W(new R(e.type.children),e)]}else{if(Array.isArray(e))return e.flatMap(h=>d(h));if("function"===typeof e[Symbol.iterator])return[...e].flatMap(h=>d(h));if("object"===typeof e){var f=
...
class oj extends W{constructor(a){var b=a.fields.map(c=>O({type:c.type}));b=O({type:new J(a.fields),nullCount:0,children:b});super(a,b)}};class pj{constructor(){this.g=null;this.h=0}i(a,b){this.h=a;this.g=b;return this}version(){const a=x(this.g,this.h,4);return a?Ka(this.g,this.h+a):t.V1}headerType(){const a=x(this.g,this.h,6);return a?this.g.l[this.h+a]:E.NONE}header(a){const b=x(this.g,this.h,8);return b?Ma(this.g,a,this.h+b):null}bodyLength(){const a=x(this.g,this.h,10);return a?La(this.g,this.h+a):BigInt("0")}Ba(a){const b=x(this.g,this.h,12);return b?(new Cb).i(Pa(this.g,Qa(this.g,this.h+b)+4*a),this.g):null}Ca(){const a=x(this.g,
...
(b||[])[0]);case "map":return new pe((b||[])[0],a.type.keysSorted)}throw Error(`Unrecognized type: "${c}"`);};class Ej{static fromJSON(a,b){const c=new Ej(0,t.V5,b);c.Ka=Fj(a,b);return c}static decode(a){a=new Sa(p(Uint8Array,a));a=(new pj).i(a.u(a.position())+a.position(),a);var b=a.bodyLength();const c=a.version(),d=a.headerType();b=new Ej(b,c,d);b.Ka=Gj(a,d);return b}static encode(a){const b=new gb;let c=-1;a.isSchema()?c=R.encode(b,a.header()):a.isRecordBatch()?c=tj.encode(b,a.header()):a.isDictionaryBatch()&&(c=Hj.encode(b,a.header()));z(b,5);Za(b,t.V5,t.V1);y(b,2,c);Ya(b,1,a.headerType,E.NONE);ab(b,
3,BigInt(a.bodyLength));a=A(b);b.finish(a);return Ta(b)}static from(a,b=0){if(a instanceof R)return new Ej(0,t.V5,E.Schema,a);if(a instanceof tj)return new Ej(b,t.V5,E.RecordBatch,a);if(a instanceof Hj)return new Ej(b,t.V5,E.DictionaryBatch,a);throw Error(`Unrecognized Message header: ${a}`);}get type(){return this.headerType}get version(){return this.Kb}get headerType(){return this.Gb}get bodyLength(){return this.Bb}header(){return this.Ka()}isSchema(){return this.headerType===E.Schema}isRecordBatch(){return this.headerType===
E.RecordBatch}isDictionaryBatch(){return this.headerType===E.DictionaryBatch}constructor(a,b,c,d){this.Kb=b;this.Gb=c;this.body=new Uint8Array(0);d&&(this.Ka=()=>d);this.Bb=H(a)}}class tj{get L(){return this.Na}get length(){return this.Jb}get buffers(){return this.Ha}constructor(a,b,c){this.Na=b;this.Ha=c;this.Jb=H(a)}}
class Hj{get id(){return this.Hb}get data(){return this.Db}get Ea(){return this.Ib}get length(){return this.data.length}get L(){return this.data.L}get buffers(){return this.data.buffers}constructor(a,b,c=!1){this.Db=a;this.Ib=c;this.Hb=H(b)}}class Aj{constructor(a,b){this.offset=H(a);this.length=H(b)}}class yj{constructor(a,b){this.length=H(a);this.nullCount=H(b)}}
...
function Uj(a){const b=new Map;if(a)for(let c,d,e=-1,f=Math.trunc(a.Ca());++e<f;)(c=a.Ba(e))&&null!=(d=c.key())&&b.set(d,c.value());return b}function Wj(a){return new vc(a.isSigned(),a.bitWidth())}
...
function Kj(a,b){var c=b.fields.map(d=>S.encode(a,d));db(a,4,c.length,4);c=Sb(a,c);b=b.metadata&&0<b.metadata.size?Tb(a,[...b.metadata].map(([d,e])=>{d=fb(a,`${d}`);e=fb(a,`${e}`);z(a,2);y(a,0,d);y(a,1,e);return A(a)})):-1;z(a,4);y(a,1,c);Za(a,Yj?tb.Ab:tb.Tb,tb.Ab);-1!==b&&y(a,2,b);return A(a)}
...
class gk extends ek{constructor(a){super(new Uint8Array(0));this.P=!1;this.ua=[];this.W=this.gb=0;this.la=a instanceof nh?a:new nh(a)}next(){var a=this.la;if(!this.P)return this.P=!0,{done:!1,value:Ej.fromJSON(a.schema,E.Schema)};if(this.W<a.dictionaries.length)return a=a.dictionaries[this.W++],this.ua=a.data.columns,{done:!1,value:Ej.fromJSON(a,E.DictionaryBatch)};if(this.gb<a.batches.length)return a=a.batches[this.gb++],this.ua=a.columns,{done:!1,value:Ej.fromJSON(a,E.RecordBatch)};this.ua=[];return T}readMessageBody(){function a(b){return(b||
[]).reduce((c,d)=>[...c,...(d.VALIDITY&&[d.VALIDITY]||[]),...(d.TYPE_ID&&[d.TYPE_ID]||[]),...(d.OFFSET&&[d.OFFSET]||[]),...(d.DATA&&[d.DATA]||[]),...a(d.children)],[])}return a(this.ua)}readMessage(a){let b;if((b=this.next()).done)return null;if(null!=a&&b.value.headerType!==a)throw Error(ak(a));return b.value}readSchema(){const a=E.Schema,b=this.readMessage(a),c=b?.header();if(!b||!c)throw Error(bk(a));return c}}const hk=new Uint8Array(6);for(let a=0;6>a;a+=1)hk[a]="ARROW1".codePointAt(a);
...
class vk extends nk{constructor(a){super(a);this.s=a}}class wk extends uk{constructor(a){super(a);this.s=a}}function xk(a,b,c){c=a.Ma(b,c,a.schema.fields);b=O({type:new J(a.schema.fields),length:b.length,children:c});return new W(a.schema,b)}function yk(a,b,c){var d=b.id;const e=b.Ea,f=a.schema,h=a.dictionaries.get(d);return e||!h?(d=f.dictionaries.get(d),a=a.Ma(b.data,c,[d]),(h&&e?h.concat(new L(a)):new L(a)).memoize()):h.memoize()}
class zk{get numDictionaries(){return this.W}get numRecordBatches(){return this.O}constructor(a=new Map){this.closed=!1;this.autoDestroy=!0;this.O=this.W=0;this.dictionaries=a}isSync(){return!1}isAsync(){return!1}isFile(){return!1}isStream(){return!1}reset(a){this.O=this.W=0;this.schema=a;this.dictionaries=new Map;return this}Ma(a,b,c){return(new Ih(b,a.L,a.buffers,this.dictionaries,this.schema.Fa)).visitMany(c)}}
...
this.autoDestroy&&(this.closed=!0)?this.reset().v.return(a):T}next(){if(this.closed)return T;for(var a,b=this.v;a=this.na();)if(a.isSchema())this.reset(a.header());else{if(a.isRecordBatch()){this.O++;var c=a.header();b=b.readMessageBody(a.bodyLength);return{done:!1,value:xk(this,c,b)}}a.isDictionaryBatch()&&(this.W++,c=a.header(),a=b.readMessageBody(a.bodyLength),a=yk(this,c,a),this.dictionaries.set(c.id,a))}return this.schema&&0===this.O?(this.O++,{done:!1,value:new oj(this.schema)}):this.return()}na(){return this.v.readMessage(void 0)}}
...
this.autoDestroy&&(this.closed=!0)?await this.reset().v.return(a):T}async next(){if(this.closed)return T;for(var a,b=this.v;a=await this.na();)if(a.isSchema())await this.reset(a.header());else{if(a.isRecordBatch()){this.O++;var c=a.header();b=await b.readMessageBody(a.bodyLength);return{done:!1,value:xk(this,c,b)}}a.isDictionaryBatch()&&(this.W++,c=a.header(),a=await b.readMessageBody(a.bodyLength),a=yk(this,c,a),this.dictionaries.set(c.id,a))}return this.schema&&0===this.O?(this.O++,{done:!1,value:new oj(this.schema)}):
await this.return()}async na(){return await this.v.readMessage(void 0)}}
class Dk extends Ak{get footer(){return this.m}get numDictionaries(){return this.m?this.m.numDictionaries:0}get numRecordBatches(){return this.m?this.m.numRecordBatches:0}constructor(a){super(a instanceof xh?a:new xh(a))}isSync(){return!0}isFile(){return!0}open(a){if(!this.closed&&!this.m){this.schema=(this.m=this.Qa()).schema;for(const b of jh(this.m))b&&this.Pa(this.W++)}return super.open(a)}readRecordBatch(a){if(this.closed)return null;this.m||this.open();if((a=this.m?.ea(a))&&this.I.seek(a.offset)){var b=
this.v.readMessage(E.RecordBatch);if(b?.isRecordBatch())return a=b.header(),b=this.v.readMessageBody(b.bodyLength),xk(this,a,b)}return null}Pa(a){if((a=this.m?.Da(a))&&this.I.seek(a.offset)){var b=this.v.readMessage(E.DictionaryBatch);b?.isDictionaryBatch()&&(a=b.header(),b=this.v.readMessageBody(b.bodyLength),b=yk(this,a,b),this.dictionaries.set(a.id,b))}}Qa(){var a=this.I;const b=a.size-kk,c=a.u(b);a=a.fa(b-c,c);return kh.decode(a)}na(){this.m||this.open();if(this.m&&this.O<this.numRecordBatches){const a=
this.m?.ea(this.O);if(a&&this.I.seek(a.offset))return this.v.readMessage(void 0)}return null}}
class Ek extends Ck{get footer(){return this.m}get numDictionaries(){return this.m?this.m.numDictionaries:0}get numRecordBatches(){return this.m?this.m.numRecordBatches:0}constructor(a){var b=[];const c="number"!==typeof b[0]?b.shift():void 0;b=b[0]instanceof Map?b.shift():void 0;super(a instanceof yh?a:new yh(a,c),b)}isFile(){return!0}isAsync(){return!0}async open(a){if(!this.closed&&!this.m){this.schema=(this.m=await this.Qa()).schema;for(const b of jh(this.m))b&&await this.Pa(this.W++)}return await super.open(a)}async readRecordBatch(a){if(this.closed)return null;
this.m||await this.open();if((a=this.m?.ea(a))&&await this.I.seek(a.offset)){var b=await this.v.readMessage(E.RecordBatch);if(b?.isRecordBatch())return a=b.header(),b=await this.v.readMessageBody(b.bodyLength),xk(this,a,b)}return null}async Pa(a){if((a=this.m?.Da(a))&&await this.I.seek(a.offset)){var b=await this.v.readMessage(E.DictionaryBatch);b?.isDictionaryBatch()&&(a=b.header(),b=await this.v.readMessageBody(b.bodyLength),b=yk(this,a,b),this.dictionaries.set(a.id,b))}}async Qa(){var a=this.I;
a.G&&await a.G;const b=a.size-kk,c=await a.u(b);a=await a.fa(b-c,c);return kh.decode(a)}async na(){this.m||await this.open();if(this.m&&this.O<this.numRecordBatches){const a=this.m.ea(this.O);if(a&&await this.I.seek(a.offset))return await this.v.readMessage(void 0)}return null}}class ok extends Ak{Ma(a,b,c){return(new Jh(b,a.L,a.buffers,this.dictionaries,this.schema.Fa)).visitMany(c)}}function Bk(a,b){return b&&"boolean"===typeof b.autoDestroy?b.autoDestroy:a.autoDestroy}
...
async function qk(a){const b=await a.peek(jk+7&-8);return b&&4<=b.byteLength?ik(b)?new vk(new Dk(await a.read())):new uk(new Ck(a)):new uk(new Ck(async function*(){}()))}async function pk(a){const {size:b}=await a.stat();a=new yh(a,b);return b>=lk&&ik(await a.fa(0,jk+7&-8))?new wk(new Ek(a)):new uk(new Ck(a))};class Fk extends ze{static pa(...a){const b=d=>d.flatMap(e=>Array.isArray(e)?b(e):e instanceof W?e.data.children:e.data),c=new Fk;c.visitMany(b(a));return c}constructor(){super();this.va=0;this.Na=[];this.Ha=[];this.Cb=[]}visit(a){if(a instanceof L)return this.visitMany(a.data),this;const b=a.type;if(!I.isDictionary(b)){const c=a.length;if(2147483647<c)throw new RangeError("Cannot write arrays larger than 2^31 - 1 in length");if(I.isUnion(b))this.L.push(new yj(c,0));else{const d=a.nullCount;I.isNull(b)||
Gk.call(this,0>=d?new Uint8Array(0):qg(a.offset,c,a.nullBitmap));this.L.push(new yj(c,d))}}return super.visit(a)}visitNull(){return this}visitDictionary(a){return this.visit(a.clone(a.type.indices))}get L(){return this.Na}get buffers(){return this.Ha}get byteLength(){return this.va}get Ua(){return this.Cb}}function Gk(a){const b=a.byteLength+7&-8;this.buffers.push(a);this.Ua.push(new Aj(this.va,b));this.va+=b;return this}function Hk(a){return Gk.call(this,a.values.subarray(0,a.length*a.stride))}
...
function*Nk(a,b){a=new Uint32Array(a.buffer);for(let c=-1,d=a.length/b;++c<d;)yield`${pc.new(a.subarray((c+0)*b,(c+1)*b),!1)}`};function Y(a,b){a.oa&&(b=p(Uint8Array,b))&&0<b.byteLength&&(a.H.write(b),a.ma+=b.byteLength);return a}function Pk(a,b){return 0<b?Y(a,new Uint8Array(b)):a}function Qk(a,b){let c,d,e;for(let f=-1,h=b.length;++f<h;)(c=b[f])&&0<(d=c.byteLength)&&(Y(a,c),0<(e=(d+7&-8)-d)&&Pk(a,e))}
class Rk extends qh{static throughNode(){throw Error('"throughNode" not available in this environment');}static throughDOM(){throw Error('"throughDOM" not available in this environment');}constructor(a){super();this.ma=0;this.oa=!1;this.H=new sh;this.P=null;this.ka=[];this.xa=[];this.ca=new Map;m(a)||(a={autoDestroy:!0,zb:!1});this.ta="boolean"===typeof a.autoDestroy?a.autoDestroy:!0;this.Ra="boolean"===typeof a.zb?a.zb:!1}toString(a=!1){return this.H.toString(a)}toUint8Array(a=!1){return this.H.toUint8Array(a)}writeAll(a){return m(a)&&
l(a.then)?a.then(b=>this.writeAll(b)):m(a)&&l(a[Symbol.asyncIterator])?Sk(this,a):Tk(this,a)}get closed(){return this.H.closed}[Symbol.asyncIterator](){return this.H[Symbol.asyncIterator]()}toDOMStream(a){return this.H.toDOMStream(a)}toNodeStream(a){return this.H.toNodeStream(a)}close(){return this.reset().H.close()}abort(a){return this.reset().H.abort(a)}finish(){this.ta?this.close():this.reset(this.H,this.P);return this}reset(a=this.H,b=null){a===this.H||a instanceof sh?this.H=a:(this.H=new sh,
a&&m(a)&&l(a.abort)&&l(a.getWriter)&&!da(a)?this.toDOMStream({type:"bytes"}).pipeTo(a):a&&m(a)&&l(a.end)&&l(a.write)&&"boolean"===typeof a.writable&&!da(a)&&ph(this.toNodeStream({Wb:!1}),a));this.oa&&this.P&&this.za(this.P);this.oa=!1;this.ka=[];this.xa=[];this.ca=new Map;b&&aj(b,this.P)||(null==b?(this.ma=0,this.P=null):(this.oa=!0,this.P=b,this.Sa(b)));return this}write(a){let b=null;if(this.H){if(null==a||a instanceof X&&!(b=a.schema)||a instanceof W&&!(b=a.schema))return this.finish()&&void 0}else throw Error("RecordBatchWriter is closed");
if(b&&!aj(b,this.P)){if(this.oa&&this.ta)return this.close();this.reset(this.H,b)}a instanceof W?a instanceof oj||this.ob(a):a instanceof X?this.writeAll(a.batches):m(a)&&l(a[Symbol.iterator])&&this.writeAll(a)}Aa(a){const b=Ej.encode(a),c=b.byteLength,d=this.Ra?4:8,e=c+d+7&-8,f=e-c-d;a.headerType===E.RecordBatch?this.xa.push(new mh(e,a.bodyLength,this.ma)):a.headerType===E.DictionaryBatch&&this.ka.push(new mh(e,a.bodyLength,this.ma));this.Ra||Y(this,Int32Array.of(-1));Y(this,Int32Array.of(e-d));
0<c&&Y(this,b);return Pk(this,f)}Sa(a){this.Aa(Ej.from(a))}za(){return this.Ra?Y(this,Int32Array.of(0)):Y(this,Int32Array.of(-1,0))}ob(a){const {byteLength:b,L:c,Ua:d,buffers:e}=Fk.pa(a);var f=new tj(a.numRows,c,d);f=Ej.from(f,b);Qk(this.ya(a).Aa(f),e)}nb(a,b,c=!1){this.ca.set(b,a.length+(this.ca.get(b)||0));const {byteLength:d,L:e,Ua:f,buffers:h}=Fk.pa(new L([a]));a=new tj(a.length,e,f);b=new Hj(a,b,c);b=Ej.from(b,d);Qk(this.Aa(b),h)}ya(a){for(let [b,c]of a.dictionaries)if(a=this.ca.get(b)||0,0===
a||0<(c=c?.slice(a)).length)for(const d of c.data)this.nb(d,b,0<a),a+=d.length;return this}}class Uk extends Rk{static writeAll(a,b){const c=new Uk(b);return m(a)&&l(a.then)?a.then(d=>c.writeAll(d)):m(a)&&l(a[Symbol.asyncIterator])?Sk(c,a):Tk(c,a)}}
class Vk extends Rk{static writeAll(a){const b=new Vk;return m(a)&&l(a.then)?a.then(c=>b.writeAll(c)):m(a)&&l(a[Symbol.asyncIterator])?Sk(b,a):Tk(b,a)}constructor(){super();this.ta=!0}Sa(){Pk(Y(this,hk),2)}za(a){const b=kh.encode(new kh(a,t.V5,this.xa,this.ka));return Y(Y(Y(super.za(a),b),Int32Array.of(b.byteLength)),hk)}}
class Wk extends Rk{static writeAll(a){return(new Wk).writeAll(a)}constructor(){super();this.ta=!0;this.Z=[];this.ba=[]}Aa(){return this}za(){return this}Sa(a){Y(this,`{\n  "schema": ${JSON.stringify({fields:a.fields.map(b=>Xk(b))},null,2)}`)}ya(a){0<a.dictionaries.size&&this.ba.push(a);return this}nb(a,b,c=!1){this.ca.set(b,a.length+(this.ca.get(b)||0));Y(this,0===this.ka.length?"    ":",\n    ");Y(this,Yk(a,b,c));this.ka.push(new mh(0,0,0))}ob(a){this.ya(a);this.Z.push(a)}close(){if(0<this.ba.length){Y(this,
',\n  "dictionaries": [\n');for(var a of this.ba)super.ya(a);Y(this,"\n  ]")}if(0<this.Z.length){for(let b=-1,c=this.Z.length;++b<c;){Y(this,0===b?',\n  "batches": [\n    ':",\n    ");a=this.Z[b];const [d]=Mk.pa(a);a=JSON.stringify({count:a.numRows,columns:d},null,2);Y(this,a);this.xa.push(new mh(0,0,0))}Y(this,"\n  ]")}this.P&&Y(this,"\n}");this.ba=[];this.Z=[];return super.close()}}
function Tk(a,b){let c=b;b instanceof X&&(c=b.batches,a.reset(void 0,b.schema));for(const d of c)a.write(d);return a.finish()}async function Sk(a,b){for await(const c of b)a.write(c);return a.finish()}function Xk({name:a,type:b,nullable:c}){const d=new Lk;return{name:a,nullable:c,type:d.visit(b),children:(b.children||[]).map(e=>Xk(e)),dictionary:I.isDictionary(b)?{id:b.id,isOrdered:b.isOrdered,indexType:d.visit(b.indices)}:void 0}}
function Yk(a,b,c=!1){const [d]=Mk.pa(new W({[b]:a}));return JSON.stringify({id:b,isDelta:c,data:{count:a.length,columns:d}},null,2)};function Zk(a,b){function c(f,h){let k,n,q=f.desiredSize||null;for(;!(n=h.next(e?q:null)).done;)if(ArrayBuffer.isView(n.value)&&(k=p(Uint8Array,n.value))&&(null!=q&&e&&(q=q-k.byteLength+1),n.value=k),f.enqueue(n.value),null!=q&&0>=--q)return;f.close()}let d=null;const e="bytes"===b?.type||!1;return new ReadableStream({...b,start(f){c(f,d||=a[Symbol.iterator]())},pull(f){d?c(f,d):f.close()},cancel(){d?.return&&d.return();d=null}},{highWaterMark:e?b?.highWaterMark||2**24:void 0,...b})}
